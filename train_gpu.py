...
def get_args_parser():
    parser = argparse.ArgumentParser(
        'Agent-Attention-Models training and evaluation script', add_help=False)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('Agent-Attention-Models training and evaluation script', parents=[get_args_parser()])

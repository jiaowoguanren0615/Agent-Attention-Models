...
class CSWinTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=96, depth=[2, 2, 6, 2],
                 ...
                 agent_num=[49, 49, 49, 49], attn_type='AAAA', **kwargs):
        super().__init__()
...
### 224 models
@register_model
def Agent_CSWin_64_24181_tiny_224(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    model = CSWinTransformer(patch_size=4, embed_dim=64, depth=[2, 4, 18, 1], split_size=[1, 2, 7, 7], drop_path_rate=0.2,
                             num_heads=[2, 4, 8, 16], mlp_ratio=4., agent_num=[9, 16, 49, 49], attn_type='AABB', **kwargs)
    model.default_cfg = default_cfgs['cswin_224']
    return model


@register_model
def Agent_CSWin_64_36292_small_224(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    model = CSWinTransformer(patch_size=4, embed_dim=64, depth=[3, 6, 29, 2], split_size=[1, 2, 7, 7], drop_path_rate=0.4,
                             num_heads=[2, 4, 8, 16], mlp_ratio=4., agent_num=[9, 16, 49, 49], attn_type='AABB', **kwargs)
    model.default_cfg = default_cfgs['cswin_224']
    return model
...
@register_model
def Agent_CSWin_96_36292_base_224(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    model = CSWinTransformer(patch_size=4, embed_dim=96, depth=[3, 6, 29, 2], split_size=[1, 2, 7, 7], drop_path_rate=0.5,
                             num_heads=[4, 8, 16, 32], mlp_ratio=4., agent_num=[9, 16, 49, 49], attn_type='AABB', **kwargs)
    model.default_cfg = default_cfgs['cswin_224']
    return model
...
### 384 models
@register_model
def Agent_CSWin_96_36292_base_384(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    model = CSWinTransformer(patch_size=4, embed_dim=96, depth=[3, 6, 29, 2], split_size=[96, 48, 24, 12], drop_path_rate=0.7,
                             num_heads=[4, 8, 16, 32], mlp_ratio=4., agent_num=[9, 16, 49, 49], attn_type='AABB', **kwargs)
